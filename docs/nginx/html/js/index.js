...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const loadRagOptions = () => {
        ...
        fetch('http://localhost:8090/api/v1/rag/queryRagTagList')
...
function startEventStream(message) {
    ...
    if (ragTag) {
        ...
        url = `http://localhost:8090/api/v1/${aiModelValue}/generateStream?message=${encodeURIComponent(message)}&model=${encodeURIComponent(aiModelModel)}`;
    }
